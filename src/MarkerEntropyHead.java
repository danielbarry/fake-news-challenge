...
/**
 * MarkerEntropyHead.java
 *
 * Use the Marker class to calculate the entropy in the head.
 **/
public class MarkerEntropyHead implements Marker{
  private static final String name = "#entropy_head";
  ...
  public double analyse(DataSet ds, int y){
    ...
    return strEntropy(holder.getString(DataSet.HEAD_LOCATION, y));
  }
